...
class RateOfIncreasePage extends StatefulWidget {
  final int baseNum;
  final List<int> powerList;
  const RateOfIncreasePage(
      {Key? key, required this.baseNum, required this.powerList})
      : super(key: key);

  @override
  State<RateOfIncreasePage> createState() => _RateOfIncreasePageState();
}

class _RateOfIncreasePageState extends State<RateOfIncreasePage> {
