...
class AverageAnnualGrowthRateExample extends StatefulWidget {
  final int baseNum;
  final List<int> powerList;
  const AverageAnnualGrowthRateExample(
      {Key? key, required this.baseNum, required this.powerList})
      : super(key: key);

  @override
  State<AverageAnnualGrowthRateExample> createState() =>
      _AverageAnnualGrowthRateExampleState();
}

class _AverageAnnualGrowthRateExampleState
    extends State<AverageAnnualGrowthRateExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('AverageAnnualGrowthRateExample'),
        ),
        body: Stack(
          children: [
            ListView.builder(
